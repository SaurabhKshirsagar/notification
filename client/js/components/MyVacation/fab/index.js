...
import {Button,View, Icon , Badge, IconNB ,Text } from 'native-base';
...
export default class Fab extends Component {
    ...
    getInitialStyle() {
        return {
            fab: {
                height: (this.props.fabHeight) || 56,
                width: (this.props.fabWidth) || 56,
                borderRadius: (this.props.fabborderRadius)||28 ,
                elevation: 4,
                shadowColor: '#000',
